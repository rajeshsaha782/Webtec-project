				...
				<td align="center" colspan="3">
					<table  width="100%" bgcolor="Gainsboro " >
						<tr>
							...
							<td></td>
							<td></td>
							<td align="left"><a href="stock_executive_home.php?memberID=<?=$memberID?>"><img src="resources/e.jpg" height="60" width="150" /></a></td>
						...
						<tr>
							<td width="20%" valign="top">
								<table bgcolor="SkyBlue" height="550" width="100%" valign="top">
									...
									<tr height="10" >
										<td align="center">
											<a href="admin/dashboard_stock.php?memberID=<?=$memberID?>" target="contentFrame">Dashboard</a>
										</td>
									</tr>
									<tr height="10" >
										<td align="center">
								...
								<table  width="100%">
									...
									<tr>
										<td width="800" valign="top">
											<iframe name="contentFrame" frameborder="0" width="100%" height="790" src="admin/dashboard_stock.php?memberID=<?=$memberID?>"></iframe>
										</td>
									</tr>
								</table>
							</td>
